export const drawAnim = function (parentElem) {
	...
	`;
        parentElem
            ? parentElem.insertBefore(canvas.b, parentElem.querySelector('.new-container'))
    ...
    function getParticle(x, y) {
        return {
            ...
            draw() {
                ...
                ctx.a.fillStyle = `hsla(${this.hue},92%, 71%,${fillTransparent})`;
